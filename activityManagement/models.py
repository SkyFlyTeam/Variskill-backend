...
class Atividade(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    modulo = models.ForeignKey(Modulo, related_name='atividades', on_delete=models.CASCADE)
    titulo = models.CharField(max_length=255)
...
class ExecucaoAtividade(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='execucoes_atividade', on_delete=models.CASCADE)
